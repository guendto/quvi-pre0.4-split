...
For example, you can copy a website script (rule) to  your working
directory (./lua/website/) and tweak it without having to make
any changes to the quvi source code.

=item $prefix/share/quvi/docs/howtos

The contribution and development guidelines etc. can be found in
the above directory.
...
Note that you can use QUVI_HOME also.

=item B<$prefix/share/quvi/lua/website>

Contains the quvi website rule scripts used to parse the video links.
See also L</DEBUGGING>.
